...
def generate_launch_description():
    ...
    rviz_base = os.path.join(get_package_share_directory("reachy_moveit_config_ros2"), "launch")
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("reachy_moveit_config_ros2"),
        "config",
        "reachy_ros_controllers.yaml",
    )
